...
import DrawLineAnimation from '../ui/DrawLineAnimation';

const PrimaryHero: React.FC = () => {
  return (
    <div className="primaryHeroWrapper">
      <header className="section default-header full-height all-devices home-header" data-theme-section="dark">
        <div className="single-vimeo-background" style={{}}>
        ...
        <div className="container">
          <div className="row">
            <div className="col">
              <AnimatedText text="AIRO 5.O" className="desktop" />
              <AnimatedText text="AIRO 5.O" className="mobile" />
            </div>
          </div>
        </div>
        ...
        <div className="overlay overlay-scroll"></div>
        <div className="bottom-links">
          ...
          <div className="btn btn-link">
            <a href="#section-intro" className="btn-click">
              <div className="btn-content">
      ...
      <section className="section section-intro section-intro-home" id="section-intro">
        <div className="container">
          <div className="row split">
            <div className="col">
              <h3><span>Welcome to AIRO 5.O</span></h3>
            </div>
          </div>
          <div className="row split">
            <div className="col">
              <DrawLineAnimation className="draw-line">
            ...
            <div className="col">
              ...
              <div className="col-row">
                <div className="btn btn-primary">
                  <a href="#description" className="btn-click">
                    <div className="btn-content">
